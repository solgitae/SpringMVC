...
public class FrontControllerServletV4 extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        /**
         * paramMap이랑 model을 생성한 이유는 controller의 process에 파라미터를 넘기고 viewName을 반환받기 위함
         * 기존의 컨트롤러는 직접 모델뷰를 만들어서 반환했었는데 이제는 그냥 뷰네임만 반환하게끔
         */
    ...
    //paramName <<주의 userName이 아님 request에 담아서 요청한 것들을 paramName이라고 함 ex) userName,age ...등
